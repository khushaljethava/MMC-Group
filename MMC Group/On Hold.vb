...
Public Class On_Hold
    ...
    Private Sub On_Hold_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MMCDataSet.Selected' table. You can move, or remove it, as needed.
        Me.SelectedTableAdapter.Fill(Me.MMCDataSet.Selected)
    ...
    End Sub
    Private Sub On_Hold_Closed(sender As Object, e As EventArgs) Handles MyBase.Closed
    ...
    Private Sub NewInvoiceNo()
        ...
        Try
            Dim sqlString As String = "SELECT MAX(ID)+1 FROM Hold"
    ...
    Private Sub DisplayData()
        ...
        con.Open()
        Dim command As New OleDbCommand("SELECT * from Hold", con)
        Dim adapter As New OleDbDataAdapter
        Dim dt As New DataTable
        adapter.SelectCommand = command
        adapter.Fill(dt)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                con.Open()
                '    cmd.CommandText = "INSERT INTO Hold VALUES ('" & IDTextBox.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & Salary_OfferedTextBox.Text & "','" & Selected_ByTextBox.Text & "','" & Passport_Expiry_DateDateTimePicker.Text & "','" & StatusComboBox.Text & "','" & RemarkTextBox.Text.ToString & "','" & DateDateTimePicker.Text & "')"
                cmd.CommandText = " INSERT INTO Hold VALUES ('" & IDTextBox.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & DateDateTimePicker.Text & "','" & LocationComboBox.Text & "','" & Salary_OfferedTextBox.Text & "','" & Selected_ByComboBox.Text & "','" & Passport_Expiry_DateDateTimePicker.Text & "','" & StatusComboBox.Text & "','" & RemarkTextBox.Text.ToString & "')"

                cmd.Parameters.AddWithValue("@dt", OleDbType.Date).Value = Me.DateDateTimePicker.Value.Date
                cmd.Parameters.AddWithValue("@psdt", OleDbType.Date).Value = Me.Passport_Expiry_DateDateTimePicker.Value.Date
            ...
            If StatusComboBox.Text = "MEDICAL OK" Then
                ...
                cmd.ExecuteNonQuery()
            ElseIf StatusComboBox.Text = "VISA CAME" Then
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        If DataGridView1.Rows.Count > 0 Then
            ...
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM Hold WHERE ID =" & intStId, con)
                Dim dt As New DataTable
                da.Fill(dt)

                IDTextBox.Text = intStId
                NameTextBox.Text = dt.Rows(0).Item("Name")
                DateDateTimePicker.Text = dt.Rows(0).Item("Date")
                ...
                StatusComboBox.Text = dt.Rows(0).Item("Status")
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                If Me.IDTextBox.Tag & "" = "" Then
                    ...
                    ' cmd.CommandText = "INSERT INTO Hold VALUES ('" & IDTextBox.Text & "','" & DateDateTimePicker.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & Salary_OfferedTextBox.Text & "','" & Selected_ByTextBox.Text & "','" & Passport_Expiry_DateDateTimePicker.Text & "','" & StatusComboBox.Text & "','" & RemarkTextBox.Text.ToString & "')"
                    cmd.CommandText = " INSERT INTO Hold VALUES ('" & IDTextBox.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & DateDateTimePicker.Text & "','" & LocationComboBox.Text & "','" & Salary_OfferedTextBox.Text & "','" & Selected_ByComboBox.Text & "','" & Passport_Expiry_DateDateTimePicker.Text & "','" & StatusComboBox.Text & "','" & RemarkTextBox.Text.ToString & "')"
                ...
                Else
                    cmd.CommandText = "UPDATE Hold SET " &
                " [ID]='" & IDTextBox.Tag & "', " &
               " [Name]='" & NameTextBox.Text & "', " &
                ...
                " [Passport Expiry Date]='" & Passport_Expiry_DateDateTimePicker.Value.Date & "', " &
                " [Statues]='" & StatusComboBox.Text & "', " &
        ...
        If Me.DataGridView1.Rows.Count > 0 Then
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                If MessageBox.Show("Do you want to delete?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
                    ...
                    cmd.CommandText = "DELETE FROM Hold WHERE ID=" & intStID
                    cmd.ExecuteNonQuery()
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Try
            con.Open()
            Dim command As New OleDbCommand("SELECT * FROM `Hold` WHERE `Date` BETWEEN @d1 AND @d2", con)
            Dim adapter As New OleDbDataAdapter
            Dim dt As New DataTable
