...
Public Class Visa
    ...
    Private Sub Visa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MMCDataSet.Visa' table. You can move, or remove it, as needed.
        '        Me.VisaTableAdapter.Fill(Me.MMCDataSet.Visa)
        CenterToScreen()
        MaximizeBox = False
    ...
    End Sub
    Private Sub Visa_Closed(sender As Object, e As EventArgs) Handles MyBase.Closed
        'TODO: This line of code loads data into the 'MMCDataSet.Visa' table. You can move, or remove it, as needed.
        '        Me.VisaTableAdapter.Fill(Me.MMCDataSet.Visa)
    ...
    Private Sub NewInvoiceNo()
        ...
        Try
            Dim sqlString As String = "SELECT MAX(ID)+1 FROM Visa"
    ...
    Private Sub DisplayData()
        ...
        con.Open()
        Dim command As New OleDbCommand("SELECT * from Visa", con)
        Dim adapter As New OleDbDataAdapter
        Dim dt As New DataTable
        adapter.SelectCommand = command
        adapter.Fill(dt)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If Len(Trim(IND_NoTextBox.Text)) = 0 Then
            MessageBox.Show("Please Enter the IND Number", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            IND_NoTextBox.Focus()
            Exit Sub
        End If
        ...
        If Len(Trim(Agent_RefComboBox.Text)) = 0 Then
            ...
            Exit Sub
        End If
        If Len(Trim(ECR_StatusComboBox.Text)) = 0 Then
            MessageBox.Show("Please Select ECR Status", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            ECR_StatusComboBox.Focus()
            Exit Sub
        End If
        If Len(Trim(SalaryTextBox.Text)) = 0 Then
            MessageBox.Show("Please Enter Salary Details", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            SalaryTextBox.Focus()
            Exit Sub
        End If
        If Len(Trim(Selected_ByComboBox.Text)) = 0 Then
            MessageBox.Show("Please Enter  Selected By   ", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Selected_ByComboBox.Focus()
            Exit Sub
        End If
        If Len(Trim(Visa_Issue_DateDateTimePicker.Text)) = 0 Then
            MessageBox.Show("Please Select Visa Issue Date   ", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Visa_Issue_DateDateTimePicker.Focus()
            Exit Sub
        End If
        If Len(Trim(Visa_Expiry_DateDateTimePicker.Text)) = 0 Then
            MessageBox.Show("Please   Select Visa Expiry Date   ", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Visa_Expiry_DateDateTimePicker.Focus()
            Exit Sub
        End If
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                con.Open()
                cmd.CommandText = "INSERT INTO Visa VALUES ('" & IDTextBox.Text & "','" & IND_NoTextBox.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & ECR_StatusComboBox.Text & "','" & SalaryTextBox.Text & "','" & Selected_ByComboBox.Text & "','" & Visa_Issue_DateDateTimePicker.Text & "' , '" & Visa_Expiry_DateDateTimePicker.Text & "' )"
                ' cmd.Parameters.AddWithValue("@dt", OleDbType.Date).Value = Visa_Issue_DateDateTimePicker.Value
                ' cmd.Parameters.AddWithValue("@psdt", OleDbType.Date).Value = Visa_Expiry_DateDateTimePicker.Value

                cmd.ExecuteNonQuery()
                MessageBox.Show("Visa   details added", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        If DataGridView1.Rows.Count > 0 Then
            ...
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM Visa WHERE ID =" & intStId, con)
                Dim dt As New DataTable
                da.Fill(dt)

                IDTextBox.Text = intStId

                IND_NoTextBox.Text = dt.Rows(0).Item("IND No").ToString()
                NameTextBox.Text = dt.Rows(0).Item("Name").ToString()
                ...
                ECR_StatusComboBox.Text = dt.Rows(0).Item("ECR Status").ToString
                SalaryTextBox.Text = dt.Rows(0).Item("Salary")
                Selected_ByComboBox.Text = dt.Rows(0).Item("Selected By")
                Visa_Issue_DateDateTimePicker.Tag = dt.Rows(0).Item("Visa Issue Date")
                Visa_Expiry_DateDateTimePicker.Tag = dt.Rows(0).Item("Visa Expiry Date")
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                If Me.IDTextBox.Tag & "" = "" Then
                    ...
                    '  cmd.CommandText = "INSERT INTO Visa VALUES ('" & IDTextBox.Text & "','" & IND_NoTextBox.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & ECR_StatusComboBox.Text & "','" & SalaryTextBox.Text & "','" & Selected_ByTextBox.Text & "','" & Visa_Issue_DateDateTimePicker.Text & "','" & Visa_Expiry_DateDateTimePicker.Text & "')"
                    cmd.CommandText = "INSERT INTO Visa VALUES ('" & IDTextBox.Text & "','" & IND_NoTextBox.Text & "','" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoryComboBox.Text & "', '" & Mobile_NoTextBox.Text & "',  '" & Agent_RefComboBox.Text & "','" & City_VillageTextBox.Text & "','" & ECR_StatusComboBox.Text & "','" & SalaryTextBox.Text & "','" & Selected_ByComboBox.Text & "',@dt,@psdt)"
                    cmd.Parameters.AddWithValue("@dt", OleDbType.Date).Value = Visa_Issue_DateDateTimePicker.Value
                    cmd.Parameters.AddWithValue("@psdt", OleDbType.Date).Value = Visa_Expiry_DateDateTimePicker.Value
                ...
                Else
                    cmd.CommandText = "UPDATE Visa SET " &
                    " [ID]='" & IDTextBox.Text & "', " &
                    " [IND No]='" & IND_NoTextBox.Text & "', " &
                    ...
                    " [ECR Status]='" & ECR_StatusComboBox.Text & "', " &
                    " [Salary]='" & SalaryTextBox.Text & "', " &
                    " [Selected By]='" & Selected_ByComboBox.Text & "', " &
                    " [Visa Issue Date]='" & Visa_Issue_DateDateTimePicker.Value & "', " &
                    " [Visa Expiry Date]='" & Visa_Expiry_DateDateTimePicker.Value & "'" &
        ...
        If Me.DataGridView1.Rows.Count > 0 Then
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                If MessageBox.Show("Do you want to delete?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
                    ...
                    cmd.CommandText = "DELETE FROM Visa WHERE ID=" & intStID
                    cmd.ExecuteNonQuery()
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                End If
                If ComboBox1.Text = "IND No" Then
                    dt.DefaultView.RowFilter = " [IND No] LIKE '%" & SearchBox1.Text & "%'"
                ...
                End If
                If ComboBox1.Text = "Issue Date" Then
                    dt.DefaultView.RowFilter = " [Visa Issue Date] LIKE '%" & SearchBox1.Text & "%'"

                End If '                dt.DefaultView.RowFilter = " [City/Village] LIKE '%" & SearchBox1.Text & "%'"
                If ComboBox1.Text = "Expiry Date" Then
                    dt.DefaultView.RowFilter = " [Visa Expiry Date] LIKE '%" & SearchBox1.Text & "%'"
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Try
            con.Open()
            Dim command As New OleDbCommand("SELECT * FROM `Visa` WHERE `Date` BETWEEN @d1 AND @d2", con)
            Dim adapter As New OleDbDataAdapter
            Dim dt As New DataTable
