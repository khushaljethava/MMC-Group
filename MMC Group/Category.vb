...
Public Class Category
    ...
    Private Sub NewInvoiceNo()
        ...
        Try
            Dim sqlString As String = "SELECT MAX(ID)+1 FROM Category"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                con.Open()
                cmd.CommandText = "INSERT INTO Category VALUES ('" & IDTextBox.Text & "','" & AddTextBox.Text & "')"
                cmd.ExecuteNonQuery()
                MessageBox.Show("Category  details added", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
            AddTextBox.Clear()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If DataGridView1.Rows.Count > 0 Then
            ...
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                Dim da As New OleDb.OleDbDataAdapter("SELECT * FROM Category WHERE ID =" & intStId, con)
                Dim dt As New DataTable
                da.Fill(dt)

                IDTextBox.Text = intStId
                AddTextBox.Text = dt.Rows(0).Item("Category")
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If Len(Trim(AddTextBox.Text)) = 0 Then
            MessageBox.Show("Please Enter the Category", "Input Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            AddTextBox.Focus()
            Exit Sub
        End If
        Try
        ...
        If Me.DataGridView1.Rows.Count > 0 Then
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                If MessageBox.Show("Do you want to delete?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
                    ...
                    cmd.CommandText = "DELETE FROM Category WHERE ID =" & intStID
                    cmd.ExecuteNonQuery()
