...
Public Class Enquiry
    ...
    Private Sub Enquiry_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MMCDataSet.Enquiry' table. You can move, or remove it, as needed.
        ' EnquiryTableAdapter.Fill(Me.MmcDataSet1.Enquiry)
        'TODO: This line of code loads data into the 'MMCDataSet.Category' table. You can move, or remove it, as needed.
        'Me.CategoryTableAdapter.Fill(Me.MMCDataSet.Category)
        'TODO: This line of code loads data into the 'MMCDataSet.Enquiry' table. You can move, or remove it, as needed.
        'Me.EnquiryTableAdapter.Fill(Me.MMCDataSet.Category)
        CenterToScreen()

        MaximizeBox = False

        'Me.EnquiryTableAdapter1.Fill(Me.MMCDataSet.Enquiry)
    ...
    End Sub
    Private Sub Enquiry_Closed(sender As Object, e As EventArgs) Handles MyBase.Closed
    ...
    Private Sub NewInvoiceNo()
        ...
        Try
            Dim sqlString As String = "SELECT MAX(ID)+1 FROM Enquiry"
    ...
    Private Sub Combo()
        ...
        adapter.Dispose()
        command.Dispose()
        CategoreyComboBox.DataSource = dt
        CategoreyComboBox.DisplayMember = "Category"
    ...
    Private Sub DisplayData()
        ...
        Dim command As New OleDbCommand("SELECT * from Enquiry", con)
        Dim adapter As New OleDbDataAdapter
        Dim dt As New DataTable
        adapter.SelectCommand = command
        adapter.Fill(dt)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If Len(Trim(Agent_RefComboBox.Text)) = 0 Then
            ...
            Exit Sub
        End If
        'If Len(Trim(RemarkTextBox.Text)) = 0 Then
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                con.Open()
                '  cmd.CommandText = "INSERT INTO Enquiry VALUES ('" & IDTextBox.Text & "','" & DateDateTimePicker.Text & "','" & NameTextBox.Text & "','" & Passport_NoTextBox.Text & "','" & Mobile_NoTextBox.Text & "','" & City_VillageTextBox.Text & "', '" & Agent_RefComboBox.Text & "','" & RemarkTextBox.Text & "','" & CategoreyComboBox.Text & "')"
                cmd.CommandText = "INSERT INTO Enquiry VALUES ('" & IDTextBox.Text & "',@dt,'" & NameTextBox.Text & "','" & Passport_NoTextBox.Text & "','" & CategoreyComboBox.Text & "','" & Mobile_NoTextBox.Text & "','" & City_VillageTextBox.Text & "', '" & Agent_RefComboBox.Text & "','" & RemarkTextBox.Text & "')"
                cmd.Parameters.AddWithValue("@dt", OleDbType.Date).Value = Me.DateDateTimePicker.Value.Date
                cmd.ExecuteNonQuery()
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        If DataGridView1.Rows.Count > 0 Then
            ...
            If DataGridView1.SelectedRows.Count > 0 Then
                ...
                Dim da As New OleDb.OleDbDataAdapter("Select * FROM Enquiry WHERE ID =" & intStId, con)
                Dim dt As New DataTable
                da.Fill(dt)
                ...
                CategoreyComboBox.Text = dt.Rows(0).Item("Category")
        ...
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                ...
                If Me.IDTextBox.Tag & "" = "" Then
                    ...
                    cmd.CommandText = "INSERT INTO Enquiry VALUES ('" & IDTextBox.Text & "', @dt,'" & NameTextBox.Text & "', '" & Passport_NoTextBox.Text & "','" & CategoreyComboBox.Text & "', '" & Mobile_NoTextBox.Text & "', '" & City_VillageTextBox.Text & "', '" & Agent_RefComboBox.Text & "','" & RemarkTextBox.Text.ToString & "')"
                    cmd.Parameters.AddWithValue("@dt", OleDbType.Date).Value = Me.DateDateTimePicker.Value.Date
                    cmd.ExecuteNonQuery()
                    MessageBox.Show("Enquiry details added", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information)
                ...
                Else
                    ...
                    cmd.CommandText = "UPDATE Enquiry SET " &
                " [ID]='" & IDTextBox.Text & "', " &
                " [Date]= '" & DateDateTimePicker.Value.Date & "', " &
                " [Name]='" & NameTextBox.Text & "', " &
                " [Passport No]='" & Passport_NoTextBox.Text & "', " &
                " [Category]='" & CategoreyComboBox.Text & "', " &
                ...
                " WHERE ID = " & IDTextBox.Tag & ""
                    cmd.Parameters.AddWithValue("@date", OleDbType.Date).Value = Me.DateDateTimePicker.Value.Date
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            If Me.DataGridView1.Rows.Count > 0 Then
                If DataGridView1.SelectedRows.Count > 0 Then
                    Dim intStID As Integer = Me.DataGridView1.SelectedRows(0).Cells("ID").Value.ToString
                    ...
                    If MessageBox.Show("Do you want to delete?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = Windows.Forms.DialogResult.Yes Then
                        ...
                        cmd.CommandText = "DELETE FROM Enquiry WHERE ID= " & intStID
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        Try
            ...
            If Not con.State = ConnectionState.Open Then
                con.Open()
                Dim command As New OleDbCommand("SELECT * FROM `Enquiry` WHERE `Date` BETWEEN @ AND @d2", con)
                Dim adapter As New OleDbDataAdapter
                Dim dt As New DataTable
    ...
    Private Sub Agent_RefComboBox_TextChanged(sender As Object, e As EventArgs)
